            ...
            <ul className="space-y-6 w-full">
              <li className="flex flex-col md:flex-row items-center md:items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:andres@vidabuddies.com" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
                    andres@vidabuddies.com
                  </a>
                </div>
              </li>
              <li className="flex flex-col md:flex-row items-center md:items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href="tel:+19059971613" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
                    +1 (905) 997-1613
                  </a>
                </div>
              </li>
